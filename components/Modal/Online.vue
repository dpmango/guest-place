<template>
  <UiModal name="online" content-class="mt-1">
    <template #title><span class="c-primary">Онлайн</span>-показ </template>
    <template #subtitle
      >Представитель площадки <span class="c-primary">Банкетный зал лофт Форест Холл</span> свяжется с вами и организует
      просмотр удобным способом.личном кабинете.</template
    >
...
export default {
  ...
  methods: {
    ...
    ...mapActions('feedback', ['formOnlineDisplay']),
